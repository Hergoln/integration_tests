...
public class BlogApiTest {
    ...
    @Test
    public void exceptionDataIntegrityViolationExceptionShouldGenerate409ConflictStatus() throws Exception {
        UserRequest user = new UserRequest();
    ...
    @Test
    public void shouldReturnStatus404WhenAskedForUserThatDoesNotExist() throws Exception {
